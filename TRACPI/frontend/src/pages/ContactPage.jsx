            ...
            <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 lg:grid-cols-2 gap-16">
                ...
                <div className="text-white space-y-10">
                    <div>
                        ...
                        <p className="text-lg">Please fill your details or email us directly.</p>
                    </div>
                    ...
                    <div className="flex gap-6 mt-12">
                        ...
                        <a href="#" className="hover:opacity-80"><img src={mLogo} alt="Medium" className="w-8 h-8" /></a>
                        <a href="#" className="hover:opacity-80"><img src={linkedin} alt="LinkedIn" className="w-8 h-8" /></a>
                        <a href="#" className="hover:opacity-80"><img src={search} alt="Search" className="w-8 h-8" /></a>
                    </div>
                </div>
                ...
                <div className="bg-transparent">
                    ...
                    <form className="space-y-4">
                        <input type="text" placeholder="Full Name" className="w-full p-3 rounded-md bg-white text-black outline-none" />
                        <input type="text" placeholder="Contact Number" className="w-full p-3 rounded-md bg-white text-black outline-none" />
                        <input type="email" placeholder="Email Address" className="w-full p-3 rounded-md bg-white text-black outline-none" />
                        <input type="text" placeholder="Where Are You Located" className="w-full p-3 rounded-md bg-white text-black outline-none" />
                        ...
                        <textarea placeholder="Message" rows="4" className="w-full p-3 rounded-md bg-white text-black outline-none resize-none"></textarea>
                        ...
                        <div className="flex flex-col items-center gap-4 mt-6">
                            ...
                            <p className="text-white text-sm">
                                Or email <a href="mailto:hello@trackpi.com" className="text-[#FF9D00]">hello@trackpi.com</a> to get in touch with our team.
                            </p>
                        </div>
                    </form>
                </div>
