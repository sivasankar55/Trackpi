      ...
      <div className="min-h-screen flex flex-col md:flex-row items-center justify-center bg-[url('/bg.png')] bg-cover bg-center px-4 md:relative md:-left-6 md:-top-8">
        ...
        <div className="leftside mt-12 md:mt-48 ml-0 md:ml-24 w-full md:w-[768px] h-auto md:h-[611px]">
          ...
          <p className="text-[18px] md:text-[22px] mt-5 leading-relaxed font-roboto font-medium text-white">
            Trackpi is one of the best business consulting firms in Kerala. We
            have a highly experienced team that develops strategies to promote
            growth and development. With our expert consulting services, we help
            businesses thrive in a competitive environment.
          </p>

          <p className="text-[18px] md:text-[22px] mt-5 font-roboto font-medium text-white">
            Trackpi is building Kerala’s largest freelance community, where
            anyone can join instantly upon completing their freelance course.
            Focused on innovation and client-centric excellence, Trackpi
            empowers businesses and individuals for sustainable success.
          </p>
          ...
          <div className="button-group mt-7 flex flex-wrap sm:flex-nowrap justify-center sm:justify-start gap-5 w-full sm:w-auto">
            <button className="bg-yellow-600 px-4 md:px-6 py-3 rounded-md font-bold text-white hover:bg-yellow-700 transition whitespace-nowrap ">
              <Link to="/help-centre">Let's Connect</Link>
            </button>
            <button className="bg-yellow-600 px-4 md:px-6 py-3 rounded-md font-bold text-white hover:bg-yellow-700 transition whitespace-nowrap">
              Company Brochure
            </button>
                    ...
                    >
                      <div className="flex items-center justify-center w-[60px] h-[60px] bg-black group-hover:bg-blue-600 rounded-full transition-all duration-300 flex-shrink-0">
                        <img
                          src="/fbvector.png"
                          alt="Facebook"
                          className="w-[24px] h-[24px] object-contain pointer-events-none"
                        />
                      </div>
              ...
              <div className="w-full flex flex-col lg:flex-row justify-between gap-[28px]">
                <div className="w-full lg:w-[762px] flex flex-col gap-[28px]">
                  <h2 className="w-full flex justify-center lg:justify-start items-center text-[24px] sm:text-[28px] md:text-[38px] lg:text-[46px] font-bold font-roboto text-white leading-none text-center lg:text-left whitespace-nowrap overflow-hidden text-ellipsis">
                    ...
                    <span className="ml-1 sm:ml-2 font-raleway font-semibold text-orange-400">
                      – Our Mission
                    </span>
                  </h2>
                  ...
                  <p className="px-4 sm:px-6 md:px-8 text-white text-[18px] md:text-[24px] font-roboto font-medium leading-[32px] md:leading-[40px] text-justify capitalize mb-0">
                    Trackpi Private Limited Is Dedicated To Empowering
                    Businesses By Providing Strategic Insights, Innovative
                    Solutions, And Hands-On Support To Drive Sustainable Growth
                    And Operational Excellence. Through Services Such As Market
                    Research, Digital Strategy, And Sales Outsourcing, Trackpi
                    Aims To Enhance Business Performance, Optimize Processes,
                    And Build Long-Term Partnerships. The Company Is Committed
                    To Delivering Tailored Strategies That Help Businesses
                    Adapt, Compete, And Thrive In A Dynamic Marketplace.
                    Additionally, Trackpi Is Focused On Nurturing Talent By
                    Fostering Kerala’s Largest Freelance Community, Providing
                    Aspiring Freelancers With The Skills And Opportunities To
              ...
              <div className="w-full flex flex-col-reverse lg:flex-row justify-between gap-[60px]">
                ...
                <div className="w-full lg:w-[762px] flex flex-col gap-[28px] items-center lg:items-start">
                  ...
                  <p className="px-4 sm:px-6 md:px-8 text-white text-[18px] md:text-[24px] font-roboto font-medium leading-[32px] md:leading-[40px] text-justify capitalize mb-0">
                    ...
                    Partner, Helping Businesses Navigate Challenges And Achieve
                    Long-Term Success Through Innovation, Expertise, And
                    Client-Focused Solutions. The Company Strives To Be At The
                    Forefront Of Business Transformation, Continuously Evolving
                    To Meet Market Demands And Create Impactful Solutions. By
                    Fostering A Collaborative And Knowledge-Driven Ecosystem,
                    Trackpi Aims To Empower Businesses And Individuals Alike,
                    Positioning Itself As A Key Player In Driving Economic
                    Growth And Professional Development Across Industries.
                  </p>
                </div>
              </div>
              ...
              <div className="w-full flex flex-col lg:flex-row justify-between gap-[60px]">
                <div className="w-full lg:w-[742px] flex flex-col justify-start gap-[28px]">
                  <h2 className="text-[24px] sm:text-[28px] md:text-[38px] lg:text-[48px] font-bold font-roboto text-white flex justify-center lg:justify-start items-center text-center lg:text-left capitalize whitespace-nowrap overflow-hidden text-ellipsis">
                    ...
                    <span className="font-raleway font-semibold text-orange-400">
                      – Our Values
                    </span>
                  </h2>
                  <ul className="list-disc pl-6 text-white font-roboto text-[18px] md:text-[24px] leading-[32px] md:leading-[36px] capitalize text-justify space-y-2 mb-0">
                    <li>
                      <strong>Empowerment</strong> – Helping businesses grow
                      with strategic insights and support.
                    </li>
                    <li>
                      <strong>Innovation</strong> – Encouraging new technologies
                      and creative solutions.
                    </li>
                    <li>
                      <strong>Sustainability</strong> – Promoting responsible
                      growth that benefits both people and the planet.
                    </li>
                    <li>
                      <strong>Client-Centric Excellence</strong> – Delivering
                      tailored solutions with a focus on long-term success.
                    </li>
                    <li>
                      <strong>Community Development</strong> – Building Kerala’s
                      largest freelance community and fostering talent.
                    </li>
                  </ul>
                </div>
                <div className="w-full lg:w-[570px] h-[300px] md:h-[500px]">
                  <img
                    src="/values img.png"
                    alt="Our Values"
                    className="w-full h-full object-cover rounded-[15px] mb-0"
                  />
                </div>
              </div>
            </div>
