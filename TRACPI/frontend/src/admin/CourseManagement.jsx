            ...
            <div className="sticky top-0 z-[100] flex justify-between items-center px-4 sm:px-10 py-4 sm:py-5 bg-white border-b border-gray-100 shadow-sm w-full">
                <div className="flex items-center gap-3 sm:gap-10 flex-1">
                    ...
                    <div className="relative w-full max-w-[200px] sm:max-w-[320px]">
                        ...
                        />
                        <img src={SearchIcon} alt="Search" className="absolute right-3 sm:right-5 top-1/2 -translate-y-1/2 w-3 sm:w-4 h-3 sm:h-4 opacity-30" />
                    </div>
                </div>
                ...
                <div className="flex items-center gap-2 sm:gap-6 ml-2 sm:ml-4">
                    ...
                    >
                        <img src={UserIcon} alt="Profile" className="w-5 h-5 sm:w-6 sm:h-6 object-contain" />
                    </div>
                </div>
            </div>
            ...
            <div className="px-4 sm:px-10 mt-6 sm:mt-8 space-y-8 sm:space-y-10 max-w-[1600px] mx-auto">
                ...
                <div className="w-full">
                    <div className="w-full h-[45px] sm:h-[54px] bg-[#FF9D00] rounded-[12px] sm:rounded-[15px] flex items-center px-4 sm:px-6 shadow-md transition-all hover:shadow-lg focus-within:ring-2 focus-within:ring-orange-200">
                        <img src={SearchIcon} alt="Search" className="w-3.5 h-3.5 sm:w-4 sm:h-4 brightness-0 invert opacity-100" />
                        <input
                            type="text"
                        ...
                        <div className="flex flex-col sm:flex-row justify-center items-center gap-6 sm:gap-10 mt-16 mb-4 w-full">
                            <div className="flex flex-col sm:flex-row items-center gap-4 bg-gray-50 px-3 py-3 rounded-[20px] shadow-sm w-full sm:w-auto">
                                <button
                                    ...
                                    className={`w-full sm:w-auto px-8 py-2.5 rounded-[12px] bg-[#FFF8E7] text-gray-400 font-bold text-sm shadow-sm transition-all border border-[#FFD9A0]/50 ${currentPage === 1 ? 'opacity-30 cursor-not-allowed' : 'hover:bg-[#FFF3D0] hover:text-[#FF9D00]'}`}
                                >
                                    Previous
                                </button>
                                ...
                                <button
                                    ...
                                    className={`w-full sm:w-auto px-10 py-2.5 rounded-[12px] bg-[#FF9D00] text-white font-bold text-sm shadow-md transition-all ${currentPage === totalPages ? 'opacity-30 cursor-not-allowed' : 'hover:bg-[#E68E00] active:scale-95'}`}
                                >
                                    Next
                                </button>
                            </div>
